...
Sub AlphabetTest()
    ...
    For Each ws In ThisWorkbook.Sheets(sheetNames)
        ...
        Do While i <= lastRow
            ...
            ' Apply conditional formatting to column J for Quarterly Change
            With ws.Cells(summaryRow, "J").Interior
                If quarterlyChange > 0 Then
                    .Color = vbGreen ' Green for positive change
                ElseIf quarterlyChange < 0 Then
                    .Color = vbRed ' Red for negative change
                End If
            End With
